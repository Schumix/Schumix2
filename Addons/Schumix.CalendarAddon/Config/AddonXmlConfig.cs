...
namespace Schumix.CalendarAddon.Config
{
	sealed class AddonXmlConfig : AddonDefaultConfig
	{
		...
		public AddonXmlConfig(string configdir, string configfile)
		{
			...
			int Seconds = !xmldoc.SelectSingleNode("CalendarAddon/Flooding/Seconds").IsNull() ? xmldoc.SelectSingleNode("CalendarAddon/Flooding/Seconds").InnerText.ToInt32() : _seconds;
			int NumberOfMessages = !xmldoc.SelectSingleNode("CalendarAddon/Flooding/NumberOfMessages").IsNull() ? xmldoc.SelectSingleNode("CalendarAddon/Flooding/NumberOfMessages").InnerText.ToInt32() : _numberofmessages;
			int NumberOfFlooding = !xmldoc.SelectSingleNode("CalendarAddon/Flooding/NumberOfFlooding").IsNull() ? xmldoc.SelectSingleNode("CalendarAddon/Flooding/NumberOfFlooding").InnerText.ToInt32() : _numberofflooding;
