...
-- UPDATE `localized_warning` SET Text = "Today is {0}'s birthday. Most töltötte be a {1}. életévét." WHERE Language = 'enUS' AND Command = 'BirthDay';
-- base.sql-be is frissíteni ezt a sort
