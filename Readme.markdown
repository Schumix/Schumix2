...
Windows | Debug | [![Build status](https://ci.appveyor.com/api/projects/status/u8njmbb6ivqisgiu/branch/master?svg=true)](https://ci.appveyor.com/project/megax/Schumix2) | https://ci.appveyor.com/project/megax/Schumix2/build/artifacts
