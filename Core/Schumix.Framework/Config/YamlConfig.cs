...
namespace Schumix.Framework.Config
{
	public sealed class YamlConfig : DefaultConfig
	{
		...
		private void LogMap(IDictionary<YamlNode, YamlNode> nodes)
		{
			...
			bool LogDateFileName = (!nodes.IsNull() && nodes.ContainsKey("DateFileName")) ? asd.ToBoolean(nodes["DateFileName".ToYamlNode()].ToString()) : d_logdatefilename;
			int LogMaxFileSize = (!nodes.IsNull() && nodes.ContainsKey("MaxFileSize")) ? asd.ToInt32(nodes["MaxFileSize".ToYamlNode()].ToString()) : d_logmaxfilesize;
			int LogLevel = (!nodes.IsNull() && nodes.ContainsKey("LogLevel")) ? asd.ToInt32(nodes["LogLevel".ToYamlNode()].ToString()) : d_loglevel;
			...
			bool IrcLog = (!nodes.IsNull() && nodes.ContainsKey("IrcLog")) ? asd.ToBoolean(nodes["IrcLog".ToYamlNode()].ToString()) : d_irclog;
		...
		{
			bool ServerEnabled = (!nodes.IsNull() && nodes.ContainsKey("Enabled")) ? asd.ToBoolean(nodes["Enabled".ToYamlNode()].ToString()) : d_serverenabled;
			string ServerHost = (!nodes.IsNull() && nodes.ContainsKey("Host")) ? nodes["Host".ToYamlNode()].ToString() : d_serverhost;
			int ServerPort = (!nodes.IsNull() && nodes.ContainsKey("Port")) ? asd.ToInt32(nodes["Port".ToYamlNode()].ToString()) : d_serverport;
		...
		{
			bool ListenerEnabled = (!nodes.IsNull() && nodes.ContainsKey("Enabled")) ? asd.ToBoolean(nodes["Enabled".ToYamlNode()].ToString()) : d_listenerenabled;
			int ListenerPort = (!nodes.IsNull() && nodes.ContainsKey("Port")) ? asd.ToInt32(nodes["Port".ToYamlNode()].ToString()) : d_listenerport;
		...
		private void IrcMap(IDictionary<YamlNode, YamlNode> nodes)
		{
			...
			else
			{
				foreach(var irc in nodes)
				{
					...
					int Port = (!node.IsNull() && node.ContainsKey("Port")) ? asd.ToInt32(node["Port".ToYamlNode()].ToString()) : d_port;
					int ModeMask = (!node.IsNull() && node.ContainsKey("ModeMask")) ? asd.ToInt32(node["ModeMask".ToYamlNode()].ToString()) : d_modemask;
					bool Ssl = (!node.IsNull() && node.ContainsKey("Ssl")) ? asd.ToBoolean(node["Ssl".ToYamlNode()].ToString()) : d_ssl;
					...
					if(!node.IsNull() && node.ContainsKey("NickServ"))
					{
						...
						UseNickServ = (!node2.IsNull() && node2.ContainsKey("Enabled")) ? asd.ToBoolean(node2["Enabled".ToYamlNode()].ToString()) : d_usenickserv;
					...
					if(!node.IsNull() && node.ContainsKey("HostServ"))
					{
						...
						UseHostServ = (!node2.IsNull() && node2.ContainsKey("Enabled")) ? asd.ToBoolean(node2["Enabled".ToYamlNode()].ToString()) : d_usehostserv;
						HostServStatus = (!node2.IsNull() && node2.ContainsKey("Vhost")) ? asd.ToBoolean(node2["Vhost".ToYamlNode()].ToString()) : d_hostservstatus;
					}
					...
					if(!node.IsNull() && node.ContainsKey("Wait"))
					{
						...
						MessageSending = (!node2.IsNull() && node2.ContainsKey("MessageSending")) ? asd.ToInt32(node2["MessageSending".ToYamlNode()].ToString()) : d_messagesending;
					}
		...
		{
			bool Enabled = (!nodes.IsNull() && nodes.ContainsKey("Enabled")) ? asd.ToBoolean(nodes["Enabled".ToYamlNode()].ToString()) : d_mysqlenabled;
		...
		{
			bool Enabled = (!nodes.IsNull() && nodes.ContainsKey("Enabled")) ? asd.ToBoolean(nodes["Enabled".ToYamlNode()].ToString()) : d_sqliteenabled;
		...
		{
			bool Enabled = (!nodes.IsNull() && nodes.ContainsKey("Enabled")) ? asd.ToBoolean(nodes["Enabled".ToYamlNode()].ToString()) : d_addonenabled;
		...
		{
			bool Lua = (!nodes.IsNull() && nodes.ContainsKey("Lua")) ? asd.ToBoolean(nodes["Lua".ToYamlNode()].ToString()) : d_scriptsluaenabled;
			bool Python = (!nodes.IsNull() && nodes.ContainsKey("Python")) ? asd.ToBoolean(nodes["Python".ToYamlNode()].ToString()) : d_scriptspythonenabled;
		...
		{
			bool Enabled = (!nodes.IsNull() && nodes.ContainsKey("Enabled")) ? asd.ToBoolean(nodes["Enabled".ToYamlNode()].ToString()) : d_updateenabled;
		...
		{
			int MaxMemory = (!nodes.IsNull() && nodes.ContainsKey("MaxMemory")) ? asd.ToInt32(nodes["MaxMemory".ToYamlNode()].ToString()) : d_shutdownmaxmemory;
		...
		{
			int Seconds = (!nodes.IsNull() && nodes.ContainsKey("Seconds")) ? asd.ToInt32(nodes["Seconds".ToYamlNode()].ToString()) : d_floodingseconds;
			int NumberOfCommands = (!nodes.IsNull() && nodes.ContainsKey("NumberOfCommands")) ? asd.ToInt32(nodes["NumberOfCommands".ToYamlNode()].ToString()) : d_floodingnumberofcommands;
		...
		{
			bool Config = (!nodes.IsNull() && nodes.ContainsKey("Config")) ? asd.ToBoolean(nodes["Config".ToYamlNode()].ToString()) : d_cleanconfig;
			bool Database = (!nodes.IsNull() && nodes.ContainsKey("Database")) ? asd.ToBoolean(nodes["Database".ToYamlNode()].ToString()) : d_cleandatabase;
