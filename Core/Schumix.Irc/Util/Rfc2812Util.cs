...
namespace Schumix.Irc.Util
{
	...
	public static class Rfc2812Util
	{
		...
		{
			return asd.ToChar((byte)action, CultureInfo.InvariantCulture);
		}
		...
		{
			byte b = asd.ToByte(action, CultureInfo.InvariantCulture);
		...
		{
			return asd.ToChar((byte)mode, CultureInfo.InvariantCulture);
		}
		...
		{
			byte b = asd.ToByte(mode, CultureInfo.InvariantCulture);
		...
		{
			return asd.ToChar((byte)query, CultureInfo.InvariantCulture);
		}
		...
		{
			byte b = asd.ToByte(queryType, CultureInfo.InvariantCulture);
